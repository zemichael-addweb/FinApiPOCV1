...
class ClientConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mandator_license' => '\FinAPI\Client\Model\MandatorLicense',
        ...
        'products' => 'Product[]',
        'enabled_products' => '\FinAPI\Client\Model\EnabledProducts',
        ...
        'category_restrictions' => '\FinAPI\Client\Model\Category[]',
        'account_type_restrictions' => 'AccountType[]',
    ...
    protected static $openAPIFormats = [
        ...
        'account_type_restrictions' => null,
    ...
    protected static array $openAPINullables = [
		...
		'account_type_restrictions' => false,
    ...
    protected static $attributeMap = [
        ...
        'account_type_restrictions' => 'accountTypeRestrictions',
    ...
    protected static $setters = [
        ...
        'account_type_restrictions' => 'setAccountTypeRestrictions',
    ...
    protected static $getters = [
        ...
        'account_type_restrictions' => 'getAccountTypeRestrictions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('account_type_restrictions', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['business_banks_enabled'] === null) {
            $invalidProperties[] = "'business_banks_enabled' can't be null";
        }
        if ($this->container['category_restrictions'] === null) {
            $invalidProperties[] = "'category_restrictions' can't be null";
        }
        if ($this->container['account_type_restrictions'] === null) {
            $invalidProperties[] = "'account_type_restrictions' can't be null";
        }
     ...
     *
     * @return \FinAPI\Client\Model\MandatorLicense
     */
     ...
     *
     * @param \FinAPI\Client\Model\MandatorLicense $mandator_license mandator_license
     *
     * @return self
     */
     ...
     *
     * @return \FinAPI\Client\Model\PreferredConsentType
     */
     ...
     *
     * @param \FinAPI\Client\Model\PreferredConsentType $preferred_consent_type preferred_consent_type
     *
     * @return self
     */
     ...
     *
     * @return \FinAPI\Client\Model\EnabledProducts
     */
     ...
     *
     * @param \FinAPI\Client\Model\EnabledProducts $enabled_products enabled_products
     *
     * @return self
     */
     ...
     *
     * @param bool $business_banks_enabled Determines whether banks that exclusively offer business accounts are enabled for your application.
     *
     * @return self
     */
     ...
     *
     * @return \FinAPI\Client\Model\Category[]
     */
    ...
    /**
     * Gets account_type_restrictions
     *
     * @return AccountType[]
     */
    public function getAccountTypeRestrictions()
    {
        return $this->container['account_type_restrictions'];
    }

    /**
     * Sets account_type_restrictions
     *
     * @param AccountType[] $account_type_restrictions The set of account types to which your client is restricted. You can only import or update accounts that match one of the listed types. For more information, refer to the <code>accountTypes</code> field of the services:<br/>&bull; bankConnections/import<br/>&bull; bankConnections/update<br/>&bull; bankConnections/connectInterface<br/><br/>If this set is empty, then your client has no account type limitations.<br/> <strong>Type:</strong> AccountType
     *
     * @return self
     */
    public function setAccountTypeRestrictions($account_type_restrictions)
    {
        if (is_null($account_type_restrictions)) {
            throw new \InvalidArgumentException('non-nullable account_type_restrictions cannot be null');
        }
        $this->container['account_type_restrictions'] = $account_type_restrictions;
