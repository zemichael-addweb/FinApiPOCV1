...
class TrainCategorizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transaction_data' => '\FinAPI\Client\Model\TrainCategorizationTransactionData[]',
        'category_id' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \FinAPI\Client\Model\TrainCategorizationTransactionData[]
     */
     ...
     *
     * @param \FinAPI\Client\Model\TrainCategorizationTransactionData[] $transaction_data Set of transaction data (at most 100 transactions at once)<br/> <strong>Type:</strong> TrainCategorizationTransactionData
     *
     * @return self
     */
