...
class CashFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category' => '\FinAPI\Client\Model\CashFlowCategory',
        'income' => 'float',
        'spending' => 'float',
        'balance' => 'float',
    ...
    */
     ...
     * Gets category
     *
     * @return \FinAPI\Client\Model\CashFlowCategory|null
     */
     ...
     * Sets category
     *
     * @param \FinAPI\Client\Model\CashFlowCategory|null $category category
     *
     * @return self
     */
