...
class AccountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'accounts' => '\FinAPI\Client\Model\Account[]'
    ];
    ...
    */
     ...
     * Gets accounts
     *
     * @return \FinAPI\Client\Model\Account[]
     */
     ...
     * Sets accounts
     *
     * @param \FinAPI\Client\Model\Account[] $accounts List of bank accounts<br/> <strong>Type:</strong> Account
     *
     * @return self
     */
