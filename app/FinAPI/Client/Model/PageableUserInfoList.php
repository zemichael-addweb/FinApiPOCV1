...
class PageableUserInfoList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'users' => '\FinAPI\Client\Model\UserInfo[]',
    ...
    */
     ...
     * Gets users
     *
     * @return \FinAPI\Client\Model\UserInfo[]
     */
     ...
     * Sets users
     *
     * @param \FinAPI\Client\Model\UserInfo[] $users List of users information<br/> <strong>Type:</strong> UserInfo
     *
     * @return self
     */
