...
class MultiStepAuthenticationChallenge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hash' => 'string',
        'status' => '\FinAPI\Client\Model\MsaStatus',
    ...
    */
     ...
     * Gets status
     *
     * @return \FinAPI\Client\Model\MsaStatus
     */
     ...
     * Sets status
     *
     * @param \FinAPI\Client\Model\MsaStatus $status status
     *
     * @return self
     */
     ...
     *
     * @return \FinAPI\Client\Model\TwoStepProcedure[]|null
     */
