...
class CreateDirectDebitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'msg_id' => 'string',
        'account_id' => 'int',
        'direct_debit_type' => '\FinAPI\Client\Model\DirectDebitType',
        'sequence_type' => '\FinAPI\Client\Model\DirectDebitSequenceType',
        'direct_debits' => '\FinAPI\Client\Model\DirectDebitOrderParams[]',
    ...
    */
    ...
    public function setMsgId($msg_id)
    {
        ...
        if ((mb_strlen($msg_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $msg_id when calling CreateDirectDebitParams., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($msg_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msg_id when calling CreateDirectDebitParams., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \FinAPI\Client\Model\DirectDebitType
     */
     ...
     *
     * @param \FinAPI\Client\Model\DirectDebitType $direct_debit_type direct_debit_type
     *
     * @return self
     */
     ...
     * Gets sequence_type
     *
     * @return \FinAPI\Client\Model\DirectDebitSequenceType
     */
     ...
     * Sets sequence_type
     *
     * @param \FinAPI\Client\Model\DirectDebitSequenceType $sequence_type sequence_type
     *
     * @return self
     */
     ...
     * Gets direct_debits
     *
     * @return \FinAPI\Client\Model\DirectDebitOrderParams[]
     */
     ...
     * Sets direct_debits
     *
     * @param \FinAPI\Client\Model\DirectDebitOrderParams[] $direct_debits List of direct debit orders (may contain at most 15000 items). Please note that collective direct debit may not always be supported.<br/> <strong>Type:</strong> DirectDebitOrderParams
     *
     * @return self
     */
