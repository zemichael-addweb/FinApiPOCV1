...
class SubmitPaymentParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \FinAPI\Client\Model\LoginCredential[]|null $login_credentials Login credentials. May not be required when the credentials are stored in finAPI, or when the bank interface has no login credentials.<br/> <strong>Type:</strong> LoginCredential
     *
     * @return self
     */
