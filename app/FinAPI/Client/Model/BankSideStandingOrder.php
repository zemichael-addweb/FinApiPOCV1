...
/**
 * BankSideStandingOrder Class Doc Comment
 *
 * @category Class
 * @description Container for a bank-side standing order&#39;s data
 * @package  FinAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BankSideStandingOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankSideStandingOrder';
    ...
    protected static $openAPITypes = [
        ...
        'start_date' => '\DateTime',
        'end_date' => '\DateTime',
        'frequency' => '\FinAPI\Client\Model\BgStandingOrderFrequency'
    ];
    ...
    */
     ...
     * Sets import_date
     *
     * @param \DateTime $import_date <strong>Format:</strong> 'YYYY-MM-DD'T'HH:MM:SS.SSSXXX' (RFC 3339, section 5.6)<br/>Date of standing order import.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount Standing order amount
     *
     * @return self
     */
     ...
     * Gets currency
     *
     * @return \FinAPI\Client\Model\Currency
     */
     ...
     * Sets currency
     *
     * @param \FinAPI\Client\Model\Currency $currency currency
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string|null $purpose Standing order purpose. Maximum length: 2000
     *
     * @return self
     */
     ...
     * Gets frequency
     *
     * @return \FinAPI\Client\Model\BgStandingOrderFrequency
     */
     ...
     * Sets frequency
     *
     * @param \FinAPI\Client\Model\BgStandingOrderFrequency $frequency frequency
     *
     * @return self
     */
