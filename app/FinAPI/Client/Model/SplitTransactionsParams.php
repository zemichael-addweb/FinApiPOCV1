...
class SplitTransactionsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sub_transactions' => '\FinAPI\Client\Model\SubTransactionParams[]'
    ];
    ...
    */
     ...
     *
     * @return \FinAPI\Client\Model\SubTransactionParams[]
     */
     ...
     *
     * @param \FinAPI\Client\Model\SubTransactionParams[] $sub_transactions List of sub-transactions<br/> <strong>Type:</strong> SubTransactionParams
     *
     * @return self
     */
