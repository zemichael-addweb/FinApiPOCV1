...
class DeleteConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'local' => '\FinAPI\Client\Model\DeleteConsentResult',
        'remote' => '\FinAPI\Client\Model\DeleteConsentResult'
    ];
    ...
    */
     ...
     * Gets local
     *
     * @return \FinAPI\Client\Model\DeleteConsentResult
     */
     ...
     * Sets local
     *
     * @param \FinAPI\Client\Model\DeleteConsentResult $local local
     *
     * @return self
     */
     ...
     * Sets remote
     *
     * @param \FinAPI\Client\Model\DeleteConsentResult $remote remote
     *
     * @return self
     */
