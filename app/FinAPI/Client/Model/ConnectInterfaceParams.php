...
class ConnectInterfaceParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'source_banking_interface' => '\FinAPI\Client\Model\BankingInterface',
    ...
    */
     ...
     *
     * @return \FinAPI\Client\Model\BankingInterface|null
     */
     ...
     *
     * @param \FinAPI\Client\Model\BankingInterface|null $source_banking_interface source_banking_interface
     *
     * @return self
     */
     ...
     *
     * @param \FinAPI\Client\Model\LoginCredential[]|null $login_credentials Set of login credentials. Must always be passed, unless the respective bank interface does not declare any login fields.<br/> <strong>Type:</strong> LoginCredential
     *
     * @return self
     */
     ...
     * Sets account_types
     *
     * @param AccountType[]|null $account_types If specified, then finAPI will import only those accounts whose type is one of the given types. Note that when the bank connection does not contain any accounts of the given types, the operation will fail with error code NO_ACCOUNTS_FOR_TYPE_LIST.<br/><br/><b>NOTE</b>: If your client is restricted to certain account types (see <code>ClientConfiguration.accountTypeRestrictions</code>), then you may only specify account types that are enabled for you, otherwise the service will return with an error. If your client has account type restrictions and you do not specify any types, then the service will implicitly limit the types according to your client's configuration.<br/> <strong>Type:</strong> AccountType
     *
     * @return self
     */
     ...
     *
     * @param \FinAPI\Client\Model\AccountReference[]|null $account_references List of accounts for which access is requested from the bank. It must only be passed if the bank interface has the DETAILED_CONSENT property set.<br/> <strong>Type:</strong> AccountReference
     *
     * @return self
     */
