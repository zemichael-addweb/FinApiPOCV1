...
class PageablePaymentResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payments' => '\FinAPI\Client\Model\Payment[]',
    ...
    */
     ...
     * Gets payments
     *
     * @return \FinAPI\Client\Model\Payment[]
     */
     ...
     * Sets payments
     *
     * @param \FinAPI\Client\Model\Payment[] $payments List of received account payments<br/> <strong>Type:</strong> Payment
     *
     * @return self
     */
