...
class BankConnectionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'connections' => '\FinAPI\Client\Model\BankConnection[]'
    ];
    ...
    */
     ...
     * Gets connections
     *
     * @return \FinAPI\Client\Model\BankConnection[]
     */
     ...
     * Sets connections
     *
     * @param \FinAPI\Client\Model\BankConnection[] $connections List of bank connections<br/> <strong>Type:</strong> BankConnection
     *
     * @return self
     */
