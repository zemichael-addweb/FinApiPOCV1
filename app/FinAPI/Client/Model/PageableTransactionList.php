...
class PageableTransactionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transactions' => '\FinAPI\Client\Model\Transaction[]',
    ...
    */
     ...
     * Gets transactions
     *
     * @return \FinAPI\Client\Model\Transaction[]
     */
     ...
     * Sets transactions
     *
     * @param \FinAPI\Client\Model\Transaction[] $transactions Array of transactions (for the requested page)<br/> <strong>Type:</strong> Transaction
     *
     * @return self
     */
