...
class PageableKeywordRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'keyword_rules' => '\FinAPI\Client\Model\KeywordRule[]',
    ...
    */
     ...
     * Gets keyword_rules
     *
     * @return \FinAPI\Client\Model\KeywordRule[]
     */
     ...
     * Sets keyword_rules
     *
     * @param \FinAPI\Client\Model\KeywordRule[] $keyword_rules List of keyword rules<br/> <strong>Type:</strong> KeywordRule
     *
     * @return self
     */
