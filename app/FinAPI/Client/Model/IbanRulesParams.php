...
class IbanRulesParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'iban_rules' => '\FinAPI\Client\Model\IbanRuleParams[]'
    ];
    ...
    */
     ...
     * Gets iban_rules
     *
     * @return \FinAPI\Client\Model\IbanRuleParams[]
     */
     ...
     * Sets iban_rules
     *
     * @param \FinAPI\Client\Model\IbanRuleParams[] $iban_rules IBAN rule definitions.<br/> <strong>Type:</strong> IbanRuleParams
     *
     * @return self
     */
