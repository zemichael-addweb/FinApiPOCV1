...
class CashFlowList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cash_flows' => '\FinAPI\Client\Model\CashFlow[]',
        'total_income' => 'float',
    ...
    */
     ...
     * Gets cash_flows
     *
     * @return \FinAPI\Client\Model\CashFlow[]
     */
     ...
     * Sets cash_flows
     *
     * @param \FinAPI\Client\Model\CashFlow[] $cash_flows Array of cash flows<br/> <strong>Type:</strong> CashFlow
     *
     * @return self
     */
