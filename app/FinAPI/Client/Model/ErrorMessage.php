...
class ErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\FinAPI\Client\Model\ErrorDetails[]',
        'date' => '\DateTime',
        'request_id' => 'string',
        'endpoint' => 'string',
        'auth_context' => 'string',
    ...
    */
     ...
     * Gets errors
     *
     * @return \FinAPI\Client\Model\ErrorDetails[]
     */
     ...
     * Sets errors
     *
     * @param \FinAPI\Client\Model\ErrorDetails[] $errors List of errors<br/> <strong>Type:</strong> ErrorDetails
     *
     * @return self
     */
