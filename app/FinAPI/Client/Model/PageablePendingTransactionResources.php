...
class PageablePendingTransactionResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'pending_transactions' => '\FinAPI\Client\Model\PendingTransaction[]',
    ...
    */
     ...
     *
     * @return \FinAPI\Client\Model\PendingTransaction[]
     */
     ...
     *
     * @param \FinAPI\Client\Model\PendingTransaction[] $pending_transactions Array of pending transactions (for the requested page)<br/> <strong>Type:</strong> PendingTransaction
     *
     * @return self
     */
