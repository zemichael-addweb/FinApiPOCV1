...
class PageableSecurityList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'securities' => '\FinAPI\Client\Model\Security[]',
    ...
    */
     ...
     * Gets securities
     *
     * @return \FinAPI\Client\Model\Security[]
     */
     ...
     * Sets securities
     *
     * @param \FinAPI\Client\Model\Security[] $securities List of securities<br/> <strong>Type:</strong> Security
     *
     * @return self
     */
