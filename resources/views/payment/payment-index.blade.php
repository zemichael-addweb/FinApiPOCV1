    ...
    <x-slot name="slot">
        ...
        <div class="container mx-auto p-4" x-data="paymentForm()">
            ...
            <div class="my-4">
                ...
                <input type="email" name="email" id="email" x-model="email" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
            </div>

            <!-- UserName -->
            <div class="my-4">
                <label for="user_name" class="block text-sm font-medium text-gray-700">User Name</label>
                <input type="text" name="user_name" id="user_name" x-model="userName" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
            </div>

            <!-- Password -->
            <div class="my-4">
                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                <input type="password" name="password" id="password" x-model="password" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
            </div>

            <div class="my-4">
                <label for="confirm_password" class="block text-sm font-medium text-gray-700">Confirm Password</label>
                <input type="password" name="confirm_password" id="confirm_password" x-model="confirmPassword" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
            </div>
            ...
            {{-- <div class="my-4">
                <label for="fetch_order_by" class="block text-sm font-medium text-gray-700">Choose what to fetch the order by</label>
                <select name="fetch_order_by" id="fetch_order_by" x-model="fetchOrderBy" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <!-- Order ID -->
            <div class="my-4">
                <label for="confirmation_number" class="block text-sm font-medium text-gray-700">Order Confirmation Number</label>
                <input type="text" name="confirmation_number" id="confirmation_number" x-model="confirmationNumber" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
