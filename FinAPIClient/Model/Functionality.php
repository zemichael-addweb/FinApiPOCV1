...
class Functionality implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'terms_and_conditions_text' => true,
		'store_secrets' => true,
		'bank_details' => true,
		'header' => true,
		'language' => true,
    ...
    protected static $attributeMap = [
        ...
        'hide_payment_overview' => 'hidePaymentOverview'
    ];
    ...
    protected static $setters = [
        'bank_banner' => 'setBankBanner',
        'progress_bar' => 'setProgressBar',
        'bank_login_hint' => 'setBankLoginHint',
        'terms_and_conditions_text' => 'setTermsAndConditionsText',
        ...
        'account_selection' => 'setAccountSelection',
        'hide_payment_summary' => 'setHidePaymentSummary',
        'hide_payment_overview' => 'setHidePaymentOverview'
    ];
    ...
    protected static $getters = [
        'bank_banner' => 'getBankBanner',
        'progress_bar' => 'getProgressBar',
        'bank_login_hint' => 'getBankLoginHint',
        'terms_and_conditions_text' => 'getTermsAndConditionsText',
        ...
        'account_selection' => 'getAccountSelection',
        'hide_payment_summary' => 'getHidePaymentSummary',
        'hide_payment_overview' => 'getHidePaymentOverview'
    ];
    ...
    public const BANK_BANNER_RENDER = 'RENDER';
    public const BANK_BANNER_HIDDEN = 'HIDDEN';
    ...
    public const TERMS_AND_CONDITIONS_TEXT_BASIC = 'BASIC';
    public const TERMS_AND_CONDITIONS_TEXT_EXPLICIT = 'EXPLICIT';
    ...
    public const ACCOUNT_SELECTION_NONE = 'NONE';
    public const ACCOUNT_SELECTION_SINGLE = 'SINGLE';
    public const ACCOUNT_SELECTION_MULTIPLE = 'MULTIPLE';
     ...
     * @return string[]
     */
    public function getBankBannerAllowableValues()
    {
        return [
            self::BANK_BANNER_RENDER,
            self::BANK_BANNER_HIDDEN,
        ];
    }
     ...
     * @return string[]
     */
    public function getTermsAndConditionsTextAllowableValues()
    {
        return [
            self::TERMS_AND_CONDITIONS_TEXT_BASIC,
            self::TERMS_AND_CONDITIONS_TEXT_EXPLICIT,
        ];
    }
     ...
     * @return string[]
     */
    public function getAccountSelectionAllowableValues()
    {
        return [
            self::ACCOUNT_SELECTION_NONE,
            self::ACCOUNT_SELECTION_SINGLE,
            self::ACCOUNT_SELECTION_MULTIPLE,
        ];
    }
    ...
    {
        $this->setIfExists('bank_banner', $data ?? [], null);
        $this->setIfExists('progress_bar', $data ?? [], null);
        $this->setIfExists('bank_login_hint', $data ?? [], null);
        $this->setIfExists('terms_and_conditions_text', $data ?? [], null);
        ...
        $this->setIfExists('account_selection', $data ?? [], null);
        $this->setIfExists('hide_payment_summary', $data ?? [], null);
        $this->setIfExists('hide_payment_overview', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBankBannerAllowableValues();
        if (!is_null($this->container['bank_banner']) && !in_array($this->container['bank_banner'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'bank_banner', must be one of '%s'",
                $this->container['bank_banner'],
        ...
        $allowedValues = $this->getTermsAndConditionsTextAllowableValues();
        if (!is_null($this->container['terms_and_conditions_text']) && !in_array($this->container['terms_and_conditions_text'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'terms_and_conditions_text', must be one of '%s'",
                $this->container['terms_and_conditions_text'],
                implode("', '", $allowedValues)
            );
        }
        ...
        $allowedValues = $this->getAccountSelectionAllowableValues();
        if (!is_null($this->container['account_selection']) && !in_array($this->container['account_selection'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'account_selection', must be one of '%s'",
                $this->container['account_selection'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * @return string|null
     */
    public function getBankBanner()
    {
        return $this->container['bank_banner'];
    }

    /**
     * Sets bank_banner
     *
     * @param string|null $bank_banner Whether bank banner (bank logo and name) is shown on the web form<br/>&bull; <code>RENDER</code> - the bank banner will be shown;<br/>&bull; <code>HIDDEN</code> - the bank banner will NOT be shown.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>RENDER</code>.
     *
     * @return self
     */
    public function setBankBanner($bank_banner)
    {
        if (is_null($bank_banner)) {
            array_push($this->openAPINullablesSetToNull, 'bank_banner');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bank_banner', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $allowedValues = $this->getBankBannerAllowableValues();
        if (!is_null($bank_banner) && !in_array($bank_banner, $allowedValues, true)) {
        ...
        $this->container['bank_banner'] = $bank_banner;
    ...
    /**
     * Gets terms_and_conditions_text
     *
     * @return string|null
     */
    public function getTermsAndConditionsText()
    {
        return $this->container['terms_and_conditions_text'];
    }

    /**
     * Sets terms_and_conditions_text
     *
     * @param string|null $terms_and_conditions_text This will affect the text of the terms&conditions checkbox, that is shown to the end-user, and depict if the text will explicitly mention the services that will be used (AIS - Account Information Service; PIS - Payment Initiation Service)<br/>&bull; <code>BASIC</code> - the text mentions that the connection is established via finAPI;<br/>&bull; <code>EXPLICIT</code> - the text will additionally mention that both AIS and PIS are used within the connection via finAPI.<br/>&nbsp;&nbsp;&nbsp;&nbsp;<strong>NOTE:</strong> This value can be changed ONLY by our support team. Please contact <a href='mailto:support@finapi.io'>support@finapi.io</a> with the <code>profile.id</code> as soon as you have finalized the customization for other parameters.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>BASIC</code>.
     *
     * @return self
     */
    public function setTermsAndConditionsText($terms_and_conditions_text)
    {
        if (is_null($terms_and_conditions_text)) {
            array_push($this->openAPINullablesSetToNull, 'terms_and_conditions_text');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('terms_and_conditions_text', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getTermsAndConditionsTextAllowableValues();
        if (!is_null($terms_and_conditions_text) && !in_array($terms_and_conditions_text, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'terms_and_conditions_text', must be one of '%s'",
        ...
        $this->container['terms_and_conditions_text'] = $terms_and_conditions_text;
     ...
     * Sets language
     *
     * @param \FinApi\Client\Model\Language|null $language language
     *
     * @return self
     */
     ...
     *
     * @param bool|null $render_account_selection_view Whether the Web Form will render the \"Account Selection View\" for the end-user to choose which of the imported accounts should be saved to the database and available on the customer application.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>false</code><br/><br/><strong>NOTE:</strong> This parameter is deprecated. Please use <code>accountSelection</code> in the future. Not setting or setting this parameter to <code>false</code> is the same as not setting or setting <code>accountSelection=NONE</code>. Setting this parameter to <code>true</code> is the same as setting <code>importNewAccountsMode=MULTIPLE</code>.
     *
     * @return self
     * @deprecated
     */
    ...
    /**
     * Gets account_selection
     *
     * @return string|null
     */
    public function getAccountSelection()
    {
        return $this->container['account_selection'];
    }

    /**
     * Sets account_selection
     *
     * @param string|null $account_selection Whether the Web Form will render the \"Account Selection View\" for the end-user to choose which of the imported accounts should be saved to the database and available on the customer application.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>NONE</code>
     *
     * @return self
     */
    public function setAccountSelection($account_selection)
    {
        if (is_null($account_selection)) {
            array_push($this->openAPINullablesSetToNull, 'account_selection');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('account_selection', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getAccountSelectionAllowableValues();
        if (!is_null($account_selection) && !in_array($account_selection, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'account_selection', must be one of '%s'",
                    $account_selection,
        ...
        $this->container['account_selection'] = $account_selection;
    ...
    /**
     * Gets hide_payment_overview
     *
     * @return bool|null
     */
    public function getHidePaymentOverview()
    {
        return $this->container['hide_payment_overview'];
    }

    /**
     * Sets hide_payment_overview
     *
     * @param bool|null $hide_payment_overview Whether the entire payment overview is rendered on the Web Form. <br/><strong>NOTE:</strong> This value can be changed ONLY by our support team. Please contact <a href='mailto:support@finapi.io'>support@finapi.io</a> with the <code>profile.id</code> as soon as you have finalized the customization for other parameters.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>false</code>
     *
     * @return self
     */
    public function setHidePaymentOverview($hide_payment_overview)
    {
        if (is_null($hide_payment_overview)) {
            array_push($this->openAPINullablesSetToNull, 'hide_payment_overview');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hide_payment_overview', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['hide_payment_overview'] = $hide_payment_overview;
