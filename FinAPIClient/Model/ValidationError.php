...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\FinApi\Client\Model\InvalidFieldError[]',
        'timestamp' => '\DateTime',
        'endpoint' => 'string'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \FinApi\Client\Model\InvalidFieldError[]
     */
     ...
     * Sets errors
     *
     * @param \FinApi\Client\Model\InvalidFieldError[] $errors Fields that caused the error
     *
     * @return self
     */
