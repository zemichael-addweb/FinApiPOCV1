...
class Translation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bank_search_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'bank_selection_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'bank_login_view' => '\FinApi\Client\Model\TranslationBlock',
        'redirect_bank_login_view' => '\FinApi\Client\Model\TranslationBlock',
        'sca_method_selection_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'sca_challenge_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'account_selection_view_ais' => '\FinApi\Client\Model\TranslationBlock',
        'account_selection_view_pis' => '\FinApi\Client\Model\TranslationBlock',
        'data_download_view_ais' => '\FinApi\Client\Model\ShortTranslationBlock',
        'partial_confirmation_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'partial_confirmation_with_error_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'update_summary_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'confirmation_view' => '\FinApi\Client\Model\ShortTranslationBlock',
        'error_view' => '\FinApi\Client\Model\ShortTranslationBlock'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'partial_confirmation_with_error_view' => null,
    ...
    protected static array $openAPINullables = [
		...
		'partial_confirmation_with_error_view' => true,
    ...
    protected static $attributeMap = [
        ...
        'bank_selection_view' => 'bankSelectionView',
        ...
        'partial_confirmation_with_error_view' => 'partialConfirmationWithErrorView',
    ...
    protected static $setters = [
        ...
        'bank_selection_view' => 'setBankSelectionView',
        ...
        'partial_confirmation_with_error_view' => 'setPartialConfirmationWithErrorView',
    ...
    protected static $getters = [
        ...
        'bank_selection_view' => 'getBankSelectionView',
        ...
        'partial_confirmation_with_error_view' => 'getPartialConfirmationWithErrorView',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bank_selection_view', $data ?? [], null);
        ...
        $this->setIfExists('partial_confirmation_with_error_view', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \FinApi\Client\Model\ShortTranslationBlock|null
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $bank_search_view bank_search_view
     *
     * @return self
     */
    ...
    {
        return $this->container['bank_selection_view'];
    }

    /**
     * Sets bank_selection_view
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $bank_selection_view bank_selection_view
     *
     * @return self
     */
    public function setBankSelectionView($bank_selection_view)
    {
        if (is_null($bank_selection_view)) {
            array_push($this->openAPINullablesSetToNull, 'bank_selection_view');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bank_selection_view', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['bank_selection_view'] = $bank_selection_view;
     ...
     *
     * @return \FinApi\Client\Model\TranslationBlock|null
     */
     ...
     *
     * @param \FinApi\Client\Model\TranslationBlock|null $bank_login_view bank_login_view
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\TranslationBlock|null $redirect_bank_login_view redirect_bank_login_view
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $sca_method_selection_view sca_method_selection_view
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $sca_challenge_view sca_challenge_view
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\TranslationBlock|null $account_selection_view_ais account_selection_view_ais
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\TranslationBlock|null $account_selection_view_pis account_selection_view_pis
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $data_download_view_ais data_download_view_ais
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $partial_confirmation_view partial_confirmation_view
     *
     * @return self
     */
    ...
    {
        return $this->container['partial_confirmation_with_error_view'];
    }

    /**
     * Sets partial_confirmation_with_error_view
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $partial_confirmation_with_error_view partial_confirmation_with_error_view
     *
     * @return self
     */
    public function setPartialConfirmationWithErrorView($partial_confirmation_with_error_view)
    {
        if (is_null($partial_confirmation_with_error_view)) {
            array_push($this->openAPINullablesSetToNull, 'partial_confirmation_with_error_view');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partial_confirmation_with_error_view', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['partial_confirmation_with_error_view'] = $partial_confirmation_with_error_view;
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $update_summary_view update_summary_view
     *
     * @return self
     */
     ...
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $confirmation_view confirmation_view
     *
     * @return self
     */
     ...
     * Sets error_view
     *
     * @param \FinApi\Client\Model\ShortTranslationBlock|null $error_view error_view
     *
     * @return self
     */
