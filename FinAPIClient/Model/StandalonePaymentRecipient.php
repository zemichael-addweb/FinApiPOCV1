    ...
    */
    ...
    public function setBankName($bank_name)
    {
        ...
        if (!is_null($bank_name) && (mb_strlen($bank_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling StandalonePaymentRecipient., must be smaller than or equal to 128.');
        }
        if (!is_null($bank_name) && (mb_strlen($bank_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling StandalonePaymentRecipient., must be bigger than or equal to 1.');
        }
